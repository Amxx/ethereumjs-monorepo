...
exports.DelegateEIP5806Transaction = void 0;
 ...
 */
class DelegateEIP5806Transaction extends baseTransaction_js_1.BaseTransaction {
    /**
    ...
    constructor(txData, opts = {}) {
        super({ ...txData, type: types_js_1.TransactionType.DelegateEIP5806 }, opts);
    ...
    static fromSerializedTx(serialized, opts = {}) {
        if ((0, ethereumjs_util_1.equalsBytes)(serialized.subarray(0, 1), (0, util_js_1.txTypeBytes)(types_js_1.TransactionType.DelegateEIP5806)) === false) {
            throw new Error(`Invalid serialized tx input: not an EIP-5806 transaction (wrong tx type, expected: ${types_js_1.TransactionType.DelegateEIP5806}, received: ${(0, ethereumjs_util_1.bytesToHex)(serialized.subarray(0, 1))}`);
        }
    ...
    static fromValuesArray(values, opts = {}) {
        ...
        (0, ethereumjs_util_1.validateNoLeadingZeroes)({ nonce, maxPriorityFeePerGas, maxFeePerGas, gasLimit, v, r, s });
...
exports.DelegateEIP5806Transaction = DelegateEIP5806Transaction;
