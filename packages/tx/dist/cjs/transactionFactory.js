...
const eip5806Transaction_js_1 = require("./eip5806Transaction.js");
...
class TransactionFactory {
    ...
    static fromTxData(txData, txOptions = {}) {
        if (!('type' in txData) || txData.type === undefined) {
            ...
            else if ((0, types_js_1.isDelegateEIP5806TxData)(txData)) {
                return eip5806Transaction_js_1.DelegateEIP5806Transaction.fromTxData(txData, txOptions);
            }
            else {
    ...
    static fromSerializedData(data, txOptions = {}) {
        if (data[0] <= 0x7f) {
            ...
            switch (data[0]) {
                ...
                case types_js_1.TransactionType.DelegateEIP5806:
                    return eip5806Transaction_js_1.DelegateEIP5806Transaction.fromSerializedTx(data, txOptions);
                default:
