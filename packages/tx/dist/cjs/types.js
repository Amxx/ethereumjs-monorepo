...
exports.isDelegateEIP5806TxData = exports.isBlobEIP4844TxData = exports.isFeeMarketEIP1559TxData = exports.isAccessListEIP2930TxData = exports.isLegacyTxData = exports.isDelegateEIP5806Tx = exports.isBlobEIP4844Tx = exports.isFeeMarketEIP1559Tx = exports.isAccessListEIP2930Tx = exports.isLegacyTx = exports.TransactionType = exports.isAccessList = exports.isAccessListBytes = exports.Capability = void 0;
...
(function (Capability) {
     ...
     */
    Capability[Capability["EIP5806Delegate"] = 5806] = "EIP5806Delegate";
...
(function (TransactionType) {
    ...
    TransactionType[TransactionType["DelegateEIP5806"] = 4] = "DelegateEIP5806";
...
function isDelegateEIP5806Tx(tx) {
    return tx.type === TransactionType.DelegateEIP5806;
}
exports.isDelegateEIP5806Tx = isDelegateEIP5806Tx;
...
function isDelegateEIP5806TxData(txData) {
    const txType = Number((0, ethereumjs_util_1.bytesToBigInt)((0, ethereumjs_util_1.toBytes)(txData.type)));
    return txType === TransactionType.DelegateEIP5806;
}
exports.isDelegateEIP5806TxData = isDelegateEIP5806TxData;
