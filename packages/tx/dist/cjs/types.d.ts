...
export declare function isDelegateEIP5806Tx(tx: TypedTransaction): tx is DelegateEIP5806Transaction;
...
export interface EIP5806CompatibleTx<T extends TransactionType = TransactionType> extends EIP1559CompatibleTx<T> {
    readonly value: 0n;
}
...
export declare function isDelegateEIP5806TxData(txData: TypedTxData): txData is DelegateEIP5806TxData;
/**
 ...
 */
declare type DelegateEIP5806TxValuesArray = [
    Uint8Array,
    Uint8Array,
    Uint8Array,
    Uint8Array,
