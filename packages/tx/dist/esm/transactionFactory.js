...
import { TransactionType, isLegacyTxData, isAccessListEIP2930TxData, isFeeMarketEIP1559TxData, isBlobEIP4844TxData, isDelegateEIP5806TxData, } from './types.js';
    ...
    static fromTxData(txData, txOptions = {}) {
        if (!('type' in txData) || txData.type === undefined) {
            ...
            if (isLegacyTxData(txData)) {
                ...
                return DelegateEIP5806Transaction.fromTxData(txData, txOptions);
            }
            else {
        ...
        if (data[0] <= 0x7f) {
            ...
            switch (data[0]) {
                ...
                case TransactionType.DelegateEIP5806:
                    return DelegateEIP5806Transaction.fromSerializedTx(data, txOptions);
                default:
