...
export declare class TransactionFactory {
     ...
     * @param txOptions - The transaction options
     */
    static fromBlockBodyData(data: Uint8Array | Uint8Array[], txOptions?: TxOptions): DelegateEIP5806Transaction | LegacyTransaction | AccessListEIP2930Transaction | FeeMarketEIP1559Transaction | BlobEIP4844Transaction;
    /**
     ...
     */
    static fromJsonRpcProvider(provider: string | EthersProvider, txHash: string, txOptions?: TxOptions): Promise<DelegateEIP5806Transaction | LegacyTransaction | AccessListEIP2930Transaction | FeeMarketEIP1559Transaction | BlobEIP4844Transaction>;
    /**
