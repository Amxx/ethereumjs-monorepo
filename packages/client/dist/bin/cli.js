...
async function setupDevnet(prefundAddress) {
    ...
    const common = common_1.Common.fromGethGenesis(chainData, {
        chain: 'devnet',
        hardfork: common_1.Hardfork.Cancun,
...
async function inputAccounts() {
    ...
    rl.input.on('keypress', function () {
        ...
        readline_1.moveCursor(rl.output, -len, 0);
        // clear everything to the right of the cursor:
        readline_1.clearLine(rl.output, 1);
