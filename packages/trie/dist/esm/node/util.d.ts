...
export declare function decodeRawNode(raw: Uint8Array[]): BranchNode | LeafNode | ExtensionNode;
export declare function isRawNode(n: Uint8Array | NestedUint8Array): n is Uint8Array[];
export declare function decodeNode(node: Uint8Array): BranchNode | LeafNode | ExtensionNode;
