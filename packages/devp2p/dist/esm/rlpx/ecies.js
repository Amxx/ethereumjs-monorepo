...
export class ECIES {
    ...
    createAuthNonEIP8() {
        ...
        const x = ecdhX(this._remotePublicKey, this._privateKey);
        const sig = this._ecdsaSign(xor(x, this._nonce), this._ephemeralPrivateKey);
        const data = concatBytes(sig.signature, Uint8Array.from([sig.recid]), this._keccakFunction(pk2id(this._ephemeralPublicKey)), pk2id(this._publicKey), this._nonce, Uint8Array.from([0x00]));
