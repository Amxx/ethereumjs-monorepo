...
import { bytesToHex, bytesToInt, bytesToUtf8, concatBytes, equalsBytes, hexToBytes, intToBytes, utf8ToBytes, } from '@ethereumjs/util';
...
export class Peer {
    ...
    _handleDisconnect(payload) {
        ...
        if (this.DEBUG) {
            this.debug('DISCONNECT', `DISCONNECT reason: ${DISCONNECT_REASON[this._disconnectReason]} ${this._socket.remoteAddress}:${this._socket.remotePort}`, DISCONNECT_REASON[this._disconnectReason]);
        }
